(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NgpImagePickerComponent = /** @class */ (function () {
        function NgpImagePickerComponent(chRef) {
            this.chRef = chRef;
            this.config = {
                height: '240px',
                width: '320px',
                ...
                this.observer = new resizeObserver.ResizeObserver(function (entries) {
                    entries.forEach(function (entry) {
                        if (_this.showEditPanel) {
                            ...
                            var rectHolder = document.getElementById('image-full').getBoundingClientRect();
        ...
        NgpImagePickerComponent.prototype.onCrop = function (type) {
            ...
            var dataHolderRect = document.getElementById('image-full').getBoundingClientRect();
            var canvas = document.createElement('canvas');
